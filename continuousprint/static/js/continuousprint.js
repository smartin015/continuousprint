					...
					if (r.queue.length > 0) {
						...
						for(var i = 0; i < r.queue.length; i++) {
							...
							if (file["time"] == undefined) {
								...
								row = $("<div style='padding: 15px; border-bottom: 1px solid #000;background:#c2fccf'>Complete: <div style='max-width: 200px; overflow-x:scroll'>" + file.name + "</div> <div class='pull-right'>average time: " + time.toFixed(0) + suffix + " Times run:" + file.times_run + "</div></div>")
							}
